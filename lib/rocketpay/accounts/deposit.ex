defmodule Rocketpay.Accounts.Deposit do
  ...
  def call(%{"id" => id, "value" => value}) do
    Multi.new()
    |> Multi.run(:account, fn repo -> get_account(repo, id) end)
  ...
  defp update_account({:error, _reason} = error, _repo, _value), do: error

  defp update_account(account, repo, value) do
